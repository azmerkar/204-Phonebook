...
locals {
  github-repo = "https://github.com/azmerkar/204-Phonebook.git"
  github-file-url = "https://raw.githubusercontent.com/azmerkar/204-Phonebook/master/"
}
